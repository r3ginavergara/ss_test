...
if(isset($_POST['edit'])){
    $update_id= $_POST['id'];
    $status = $_POST['status'];
    $updatequery = "UPDATE clients SET status='$status' WHERE id='$update_id'";
    $updateconfirm = mysqli_query($conn,$updatequery);
    redirect('Admin/users/users.php');
...
#delete query
 if(isset($_POST['delete'])){
     ...
     $deletequery="DELETE FROM clients where id='$delete_id'";
...
<body>
	...
	<div class="card-body ">
        ...
        <div class="container-fluid">
			<div>
		<a class="btn btn-outline-primary" href="users.php" <span class="fa fa-trash text-danger"></span> Go back</a>
                   
                    </div>
                        <div class="modal-body border p-5 mx-auto  w-50">
                        <?php
                        	$qry = $conn->query("SELECT * FROM clients WHERE id = '$request_id'");
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php
                   $req = $_GET['id'];
                   $qrys = $conn->query("SELECT * FROM clients WHERE id = '$req'");
