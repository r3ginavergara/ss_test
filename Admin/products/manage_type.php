...
if(isset($_POST['edit'])){
    $id_update=$_POST['id'];
    $name_update=$_POST['category'];
    $desciption_update=$_POST['description'];
    ...
    $updatequery = "UPDATE types SET name='$name_update',description='$desciption_update',image_path='$image',status='$status_update' WHERE id='$id_update'";
    $updateconfirm = mysqli_query($conn,$updatequery);
    redirect('Admin/products/type.php');
...
#delete query
 if(isset($_POST['delete'])){
     ...
     $deletequery="DELETE FROM types where id='$delete_id'";
...
<body>
	...
	<div class="card-body ">
		...
		<a class="btn btn-outline-primary" href="farmers.php" <span class="fa fa-trash text-danger"></span> Go back</a>
                        ...
                        <?php
                        	$qry = $conn->query("SELECT * FROM types WHERE id = '$request_id'");
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php
                   $req = $_GET['id'];
                   $qrys = $conn->query("SELECT * FROM types WHERE id = '$req'");
