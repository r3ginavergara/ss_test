...
<?php
    ...
    if(isset($_POST['create'])){
        ...
        $checkcat = "SELECT * FROM types WHERE name = '$name' and description = '$description'";
        ...
        //End of File Upload
               ...
               $date_added= date("Ymd");
                ...
                $insertquery = mysqli_query($conn,"INSERT INTO types(name,description, image_path,status ,date_created) 
                VALUES ('$name','$description','$image', '$status','$date_added')");
                redirect('Admin/products/type.php');
           }
    }
    }
...
<body>
	...
	<div class="card-header">
		<h3 class="card-title">Types of Product</h3>
	...
	<div class="card-body">
        ...
        <div class="container-fluid">
			<table class="table table-hover table-strip">
                ...
                <?php
					$i = 1;
						$qry = $conn->query("SELECT * FROM types");
					...
					?>
						<tr>
							...
							<td ><p class="m-0 truncate"><?php echo $date_added ?></p></td>
							<td>
                             <?php if($status == 1): ?>
							...
							<td>
							<a  href="manage_type.php?id=<?php echo $id ?>" type="button" class="btn btn-outline-success btn-block" >Edit</a>
							</td>
						</tr>
					    <?php } ?>
				</tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <button type="submit" name="create" class="btn btn-success btn-block">Submit</button>
                </div>
            </div>
        </div>
    </div>
